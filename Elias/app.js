          ...
          <div className="login-wrap">
            <div>
              ...
              <div className="login-grid">
                <div>
                  <a href="navbar.html" ref='btnForgotPassword' onClick={() => {
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item">
                <NavLink exact="exact" to='/homepage' className="nav-link">Aktuelt
                  <span className="sr-only">(current)</span>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink exact="exact" to='/calendar' className="nav-link" href="#">Kalender</NavLink>
              </li>
              <li className="nav-item">
                <NavLink exact="exact" to='/events' className="nav-link">Arrangementer<span className="sr-only">(current)</span>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink exact="exact" to='/contact' className="nav-link" href="#">Om oss</NavLink>
              </li>
              <li className="nav-item dropdown">
                <NavLink exact="exact" to='/profile' className="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Profil
                </NavLink>
              ...
              <li className="nav-item">
                <NavLink exact="exact" to='/search' className="nav-link" href="#">Brukersøk</NavLink>
              </li>
            </ul>
...
class divEvent extends React.Component {
  render() {
    return (<div>
      ...
      <br/>
      arrangementets navn:
      <span height='300' ref='eventName'></span><br/>
      Startdato:
  ...
  render() {
    return (<div>
      ...
      <form>
        ...
        <label>
          Vaktlag:<br/>
          <select ref='rolelistSelect'></select><br/>
        </label>
        <label>
          description:<br/>
...
ReactDOM.render((<HashRouter>
  <div>
    ...
    <Switch>
      ...
      <Route excat="excat" path='/loginPage' component={LoginPage}/>
      <Route excat="excat" path='/forgotPassword' component={ForgotPassword}/>
      <Route excat="excat" path='/register' component={Register}/>
      <Route excat="excat" path='/calendar' component={Calendar}/>
      <Route excat="excat" path='/profile' component={Profile}/>
      <Route excat="excat" path='/editprofile' component={EditProfile}/>
      <Route excat="excat" path='/events' component={Events}/>
      <Route excat="excat" path='/divEvent' component={divEvent}/>
      <Route excat="excat" path='/newEvent' component={NewEvent}/>
      <Route excat="excat" path='/editEvent' component={EditEvent}/>
      <Route excat="excat" path='/contact' component={Contact}/>
      <Route excat="excat" path='/search' component={Search}/>
    </Switch>
  </div>
